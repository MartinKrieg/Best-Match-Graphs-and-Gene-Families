% Clean bipartite redraw of plots/mismatch/2_1/wBMG_explaining_2_1.gml
% This is the weak best match graph of explaining_network_2_1.gml (task_1d.py, step 4) --
% i.e. the wBMG recovered from the BIC-cherry reconstruction, to be compared
% against the original wBMG_2_1.gml (task_1d.py, step 2).
%
% Diff against wBMG_2_1.gml: every edge is identical, EXCEPT for one extra
% edge, 6 -> 9, which appears here but not in the original wBMG. That is
% exactly the mismatch this (2,1) case was saved for.
%
% Compile with: pdflatex wBMG_explaining_2_1_clean.tex
...
\begin{tikzpicture}[
  ...
  mutual/.style={<->, thick},
  oneway/.style={->, thick},
  extra/.style={->, thick, red!70!black},
]
...
% ---- edges identical to wBMG_2_1.gml ----
...
% ---- the one extra edge: present here, ABSENT from wBMG_2_1.gml ----
\draw[extra] (l6) to[bend right=10]
  node[midway, sloped, above, font=\scriptsize, text=red!70!black] {mismatch} (l9);
...
\node[anchor=north west, font=\scriptsize, align=left, draw=black!40, fill=white, inner sep=4pt, rounded corners=1pt]
  ...
  \begin{tabular}{@{}ll@{}}
    ...
    \tikz\draw[extra] (0,0) -- (0.6,0);          & edge NOT in the original wBMG\_2\_1 -- the mismatch \\
  \end{tabular}%
};
